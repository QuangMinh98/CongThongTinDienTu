			...
			<div class="content1">
				<div class="main-panel">
					<div class="box">
						...
						<div class="content">
							<form action="{{route('addSV')}}" method="post" enctype="multipart/form-data">
								@csrf
								<div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="masv">Mã Sinh Viên</label>
                      <input type="text" name="masv" class="form-control form-control-sm">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="hosv">Họ Sinh Viên</label>
                      <input type="text" name="hosv" class="form-control form-control-sm">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="tensv">Tên Sinh Viên</label>
                      <input type="text" name="tensv" class="form-control form-control-sm">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="ngaysinh">Ngày Sinh</label>
                      <input type="date" name="ngaysinh" class="form-control form-control-sm">
                    </div>
                  </div>
                  <div class="col-md-1">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="quequan" class="form-control form-control-sm">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
